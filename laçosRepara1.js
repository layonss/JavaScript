...
for (i = 0; i <=20; i++){
    ...
    soma = parseFloat(soma) + parseFloat (salario)  //indentifica como uma variavel real
    mediaF = parseFloat (mediaF) + parseFloat (filhos)
    if (mSal < salario){
...
mediaF = parseInt (mediaF) / 20; // parseInt = indentifica como uma variavel inteira.
